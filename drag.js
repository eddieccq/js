...
$.fn.extend({
    ...
    dragging:function(data){  
		...
		//var faHeight = $(window.parent.window).height();
		
		//alert(faHeight+":"+ $(window.parent.window).height());
    	...
    	$("#small_button").click( function () {
				...
				var h=$(window).height()-$(".box-3 dl dd").height()-30;
				var h1=$(window).height()-205-20;			
			if ( $(this).hasClass("up") ){
				//alert("up:"+h);
